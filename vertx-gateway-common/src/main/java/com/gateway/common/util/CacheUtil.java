...
public final class CacheUtil {
     ...
     * 获取 Hash 中所有的 Key
     */
    public Object[] hGetAllKey(String hashKey) {
        try {
     ...
     * 获取 Hash 中所有的 Value
     */
    public Object[] hGetAllValue(String hashKey) {
        try {
     ...
     * @param value 值
     */
    public Boolean lSetFromLeft(String key, Object value) {
        try {
    ...
    public Boolean lExist(String key,Object value) {
        try {
            return Objects.requireNonNull(redisTemplate.opsForList().range(key, 0, -1)).contains(value);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
