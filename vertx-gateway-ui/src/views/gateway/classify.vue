...
const load = () => {
  loading.value = true;
  classifyPage({ ...page, ...queryParams, parentId: currentAppId.value })
    .then((res) => {
      ...
      <div class="resize-right-box">
        ...
        <div class="search-box" ref="searchBox">
          ...
          >
            ...
            <el-form-item label="服务编号" prop="code" class="form-item">
              <el-input
        ...
        <el-row class="button-box">
          <el-col :span="16">
            <el-button
              v-permission="'gateway_classify_add'"
              type="primary"
              icon="CirclePlus"
              @click="handleAdd()"
              >新增</el-button
          ...
          >
            ...
            >
              <template #default="scope">
                ...
                >
                <el-button
                  v-permission="'gateway_classify_edit'"
                  link
                  type=""
                  icon="Edit"
